...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('pending_matters', function (Blueprint $table) {
            $table->id();
            $table->string('PENDING_MATTERS')->nullable();
            $table->text('DEFINISI_PENDING_MATTERS')->nullable();
            $table->text('FORMULA_PENDING_MATTERS')->nullable();
            $table->text('KOMPONEN_PENGUKURAN')->nullable();
            $table->text('PENJELASAN_PENDING_MATTERS_KOMPONEN')->nullable();
