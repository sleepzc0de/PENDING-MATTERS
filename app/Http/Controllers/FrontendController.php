...
class FrontendController extends Controller
{
    ...
    public function capaian_pm_fe()
    {
        $today = Carbon::now()->locale('id')->isoFormat('DD-MMMM-YYYY');

        $data_all = PendingMattersModel::all();
        // dd($data_all);
        // $data_multi =  PendingMattersModel::leftjoin('komponen_pm', 'pending_matters.id', '=', 'komponen_pm.ID_PENDING_MATTERS_MULTI_KOMPONEN')->get();
        // dd($data_pm);
        return view('home-capaian-pm', compact(['data_all', 'today']));
    }
    public function daftar_pm_fe()
    {


        // $data = Iku::where('iku.id', )->leftjoin('komponen', 'iku.id', '=', 'komponen.ID_IKU_MULTI_KOMPONEN');

        $query = PendingMattersModel::select('*')->orderBy('id', 'ASC');
        // dd($query);
        if (request()->ajax()) {
                                    ...
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 style="text-align-center" class="modal-title" id="myModalLabel">Detail Pending Item : ' . $query->PENDING_MATTERS . '</h4>
                                            ...
                                            <div class="row">
                                            <div class="col-lg-6">
                                            <label class="mt-2" for="KEGIATAN_YANG_TELAH_DILAKSANAKAN">STATUS</label>
    ...
    public function show($id)
    {
                    ...
                    return '<div class="d-inline-flex">
                                ...
                                <div id="myModal_' . $query->id . '" class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 style="text-align-center" class="modal-title" id="myModalLabel">Detail Pending Matters Komponen</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                             <div class="row">
        ...
        return view('daftar-komponen', compact(['query', 'current', 'data',]));
    }
